      ...
      <div className="flex h-full w-full flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="h-16 w-16">
            <Icons.anthropic className="h-6 w-6" />
          </Circle>
        </div>
...
const Icons = {
  // Center AI node = Claude / Anthropic. Loaded from the Simple Icons CDN via a
  // plain <img> (config-free, matches the favicon <img> pattern used elsewhere
  // in the app) so we avoid next/image remote-domain config. The center Circle
  // has a white background, so the default-dark Anthropic mark stays legible.
