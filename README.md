...
- **Fully responsive** — tuned from 320px through wide desktop, with swipeable marquees and zero horizontal overflow.
- **End-to-end tested** — a Playwright suite (chromium + mobile) covers the landing page, every project page, links, and overflow.
...
components/            Bento tiles, hero, ask console, magic-ui primitives
