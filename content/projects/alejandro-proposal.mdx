...
description: A proposal built as the credibility surface it was pitching - a bilingual, interactive site shipped solo in four days. The $37K engagement was signed.
repo: ""
...
- **Writing and design.** Around 4,000 words in an operator-to-operator register, with a custom editorial design system. I applied a banned-phrase list and one hard rule to every layer: no implied prior fractional clients, because I don't have any. Faking a track record would have failed the exact authenticity test the project was built around.
...
- The $37,000 engagement was accepted. I'm mid-delivery now, building out what the proposal laid out.
...
- Every layer owned solo: the diagnosis, the copy, the design system, and the full build across 88 commits.
