...
The code is private. Unlike my open-sourced tools, this one is wired into my actual email, meetings, and notes, so it stays in a private repo. What follows is how it works and why I made the calls I made.
