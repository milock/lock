...
In production for about two months. Seven sources, synced every three hours on weekdays. 127 tests at launch. It powers both my interactive assistant and the scheduled cloud agents that run overnight, including the [research pipeline](/projects/polysearch) and competitive bot, which query this memory as their long-term store.
